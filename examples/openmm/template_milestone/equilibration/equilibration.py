...
#force constant
k = XX * kilocalories_per_mole / angstroms**2 #REPLACED BY SCRIPT

#equilibrium position
x_0 = XX * angstroms #REPLACED BY SCRIPT
...
simulation.loadState('start.xml')
...
#=================== RUN SIMULATION ====================================================================#
simulation.step(XX)
simulation.saveState('equilibration.xml') #produce equilibrated restart check-point
